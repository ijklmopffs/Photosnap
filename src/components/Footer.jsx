...
import logoLight from "../assets/shared/desktop/logo-white.svg";

export default function Footer() {
  const [facebookState, setFacebookState] = useState("white");
  const [youTubeState, setYouTubeState] = useState("white");
  const [twitterState, setTwitterState] = useState("white");
  const [pinterestState, setPinterestState] = useState("white");
  const [instagramState, setInstagramState] = useState("white");

  return (
    <footer className="bg-black">
      <div className="max-w-[1110px] mx-auto p-20 lg:pl-0 flex flex-col md:flex-row justify-between">
        <div className="flex flex-col md:flex-row items-start gap-4">
          <div className="flex flex-col justify-between w-96">
            ...
            <div className="hidden md:flex lg:hidden mt-10 text-white text-start gap-8 font-bold text-xs">
              <Link to="/" className="hover:opacity-30">
                Home
              </Link>
              <Link to="/stories" className="hover:opacity-30">
                Stories
              </Link>
              <Link to="/features" className="hover:opacity-30">
                Features
              </Link>
              <Link to="/pricing" className="hover:opacity-30">
                Pricing
              </Link>
            </div>

            <div className="flex items-center mx-auto md:mx-0 gap-8 mt-10 md:mt-28">
              <Link to="/">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                  ...
                  <path
                    onMouseEnter={() => {
                      setFacebookState("url(#a)");
                    }}
                    onMouseLeave={() => {
                      setFacebookState("white");
                    }}
                    fill={facebookState}
              ...
              <Link to="/">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
                  ...
                  <path
                    onMouseEnter={() => {
                      setYouTubeState("url(#a)");
                    }}
                    onMouseLeave={() => {
                      setYouTubeState("white");
                    }}
                    fill={youTubeState}
              ...
              <Link to="/">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="18">
                  ...
                  <path
                    onMouseEnter={() => {
                      setTwitterState("url(#a)");
                    }}
                    onMouseLeave={() => {
                      setTwitterState("white");
                    }}
                    fill={twitterState}
              ...
              <Link to="/">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                  ...
                  <path
                    onMouseEnter={() => {
                      setPinterestState("url(#a)");
                    }}
                    onMouseLeave={() => {
                      setPinterestState("white");
                    }}
                    fill={pinterestState}
              ...
              <Link to="/">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20">
                  ...
                  <path
                    onMouseEnter={() => {
                      setInstagramState("url(#a)");
                    }}
                    onMouseLeave={() => {
                      setInstagramState("white");
                    }}
                    fill={instagramState}
          ...
          <div className="flex mx-auto mt-5 md:mt-0 md:mx-0 md:hidden lg:flex flex-col text-white text-start gap-8 font-bold text-xs">
            <Link to="/" className="hover:opacity-30">
              Home
            </Link>
            <Link to="/stories" className="hover:opacity-30">
        ...
        <div className="text-white">
          ...
          <p className="mt-14 md:mt-28 opacity-50">
